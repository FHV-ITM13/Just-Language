...
public class EG1 implements EG1Constants {
  ...
  static final public double evaluate() throws ParseException {
  double result;
    label_1:
    while (true) {
      if (jj_2_1(2)) {
  ...
  static final public void varDefinition() throws ParseException {
  Token var;
  Token value;
  ...
  static final public double calculate() throws ParseException {
  double value;
  double term;
    value = term();
    label_2:
  ...
  double value;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CONSTANT:
      number = jj_consume_token(CONSTANT);
    {if (true) return Integer.parseInt(number.image);}
      break;
    case VARNAME:
      var = jj_consume_token(VARNAME);
    {if (true) return Variables.getVar(var.image);}
      break;
    case 15:
      jj_consume_token(15);
      value = calculate();
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x60,0x60,0x180,0x180,0x8a00,};
   }
