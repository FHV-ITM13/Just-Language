...
<classfile>
    ...
    <constant_pool>
x    	<constant_class index="1">
    		<name_index>2</name_index>
    	</constant_class>

x		<constant_utf8 index="2">
			<bytes>ATest</bytes>
		</constant_utf8>

x		<constant_utf8 index="3">
			<bytes>Code</bytes>
		</constant_utf8>

x		<constant_utf8 index="4">
			<bytes>I</bytes>
		</constant_utf8>

x		<constant_utf8 index="5">
			<bytes>global</bytes>
		</constant_utf8>

x		<constant_utf8 index="6">
			<bytes>doIt</bytes>
		</constant_utf8>

x		<constant_utf8 index="7">
			<bytes>(I)I</bytes>
		</constant_utf8>

x		<constant_utf8 index="8">
			<bytes>main</bytes>
		</constant_utf8>

x		<constant_utf8 index="9">
			<bytes>()V</bytes>
		</constant_utf8>

x    	<constant_methodref index="10">
    		<class_index>1</class_index>
    		<name_and_type_index>11</name_and_type_index>
    	</constant_methodref>

x    	<constant_name_and_type index="11">
    		<name_index>6</name_index>
			<descriptor_index>7</descriptor_index>
    	</constant_name_and_type>

x    	<constant_methodref index="12">
    		<class_index>1</class_index>
    		<name_and_type_index>13</name_and_type_index>
    	</constant_methodref>

 x   	<constant_name_and_type index="13">
...
x		<constant_fieldref index="15">
    		<class_index>1</class_index>
    		<name_and_type_index>16</name_and_type_index>
    	</constant_fieldref>

x   	<constant_name_and_type index="16">
